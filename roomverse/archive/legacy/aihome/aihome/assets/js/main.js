...
/* ---------------------------------------------------------------- */
/* Hero banner carousel (chỉ đổi ảnh, không có logic khác)           */
/* ---------------------------------------------------------------- */
...
/* ---------------------------------------------------------------- */
/* Form tìm kiếm -> gọi api/search.php -> render lại 4 phòng trọ     */
/* ---------------------------------------------------------------- */
function initSearchForm() {
  ...
  let userCoords = null; // { lat, lng } nếu người dùng bấm "dùng vị trí của tôi"
  ...
  useLocationBtn &&
    useLocationBtn.addEventListener("click", function () {
      ...
      navigator.geolocation.getCurrentPosition(
        ...
        function () {
          alert("Không lấy được vị trí. AIHome sẽ dùng khu vực bạn đã chọn.");
  ...
  function roomCardHtml(room) {
    ...
    const mapLink = room.link_google || "#";
        ...
        <article class="room-card" data-id="${room.id}">
            ...
            <div class="room-card-body">
                ...
                <div class="room-actions">
                    ...
                    <a class="btn btn-outline btn-sm" href="${escapeHtml(mapLink)}" target="_blank" rel="noopener">🗺 Bản đồ</a>
                </div>
            </div>
        </article>`;
  }
